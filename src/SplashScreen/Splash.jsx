...
export default function Splash() {
   ...
   const logoOneMovement = useRef(new Animated.Value(0)).current;
   const logoAllMovement = useRef(new Animated.Value(-250)).current;
   const logoInMovement = useRef(new Animated.Value(250)).current;
   const insideMovement = useRef(new Animated.Value(250)).current;
   const sloganText = useRef(new Animated.Value(250)).current
   useEffect(() => {
   ...
   return (
      ...
      <Animated.Image source={require('./AllInOne.png')}
      ...
      >All Things at one place</Animated.Text>
